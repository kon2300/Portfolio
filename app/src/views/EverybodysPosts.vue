<template>
  <div class="relative">
    <div
      v-if="user"
      class="absolute justify-end text-gray-700 top-3 right-3 sm:right-11"
    >
      <button class="btn btn-action" @click="searchModalToggle">検索</button>
    </div>

    <div>
      <div class="p-3 flex justify-center font-black text-4xl">
        みんなの投稿
      </div>
      ...
      <div v-for="article in allArticle" :key="article.id">
        ...
        >
          ...
          >
            <div
              class="
                md:col-span-2 md:grid
                grid-flow-col grid-rows-2 grid-cols-2
              "
            >
              <div
                class="
